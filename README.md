...
# 📖 About 
This repository was developed during my time as a scientific initiation fellow at Instituto de Informática - UFRGS. A paper summarizing the results obtained was written for the project and can be found in this [link](https://sol.sbc.org.br/index.php/sbcas/article/view/35568/35355). This paper was submitted and accepted at SBCAS 2025 (Simpósio Brasileiro de Computação Aplicada à Saúde). 
